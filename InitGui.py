...
class FrontPanelSim (Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ["CreateDisplay", "CreateLED" , "CreateTouchSurface", "CreateLinButton", "CreateRotButton", "CreateRotaryEncoder", "CreateRotaryPotentiometer" ,"CreateLinearPotentiometer", "StartSimulation", "StopSimulation", "ExportTopology"] # A list of command names created in the line above
