...
class FrontPanelSim (Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ["CreateDisplay", "CreateLED" , "CreateTouchSurface", "CreateLinButton", "CreateRotButton", "CreateRotaryEncoder", "CreateRotaryPotentiometer" ,"CreateLinearPotentiometer", "StartSimulation", "StopSimulation", "ExportWidgetInfo"] # A list of command names created in the line above
